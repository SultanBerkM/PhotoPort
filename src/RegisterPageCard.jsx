    ...
    <div className="h-full flex items-center justify-center">
      <div className="relative">
        <img
          src="/photoLogin.jpg"   
          alt="Register"
          className="h-[600px] w-auto object-cover rounded-l-lg rounded-r-none shadow-lg"
        />
        <div className="absolute top-0 left-0 w-full flex flex-col items-center pt-8 px-4">
          ...
          <p className="text-white text-base md:text-lg mt-2 drop-shadow-lg text-center">
